...
train_args.non_val = True  # False, default, if set to True val-set will be added into training set for overfitting training
train_args.input_size = [512, 512] # 224, 384, 448, 512
train_args.scale_rate = 512./512. #
train_args.val_size = [512, 512]
train_args.train_batch = 18 # 24, 18, 16, 12

train_args.snapshot = 'xxx.pth' # copy the file name of the ckpt to resume the training with different hypeparameter..
